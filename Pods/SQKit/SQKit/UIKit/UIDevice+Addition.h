 ...
 */
typedef NS_OPTIONS(NSUInteger, BTNetworkTrafficType) {
    BTNetworkTrafficTypeWWANSent     = 1 << 0,
    BTNetworkTrafficTypeWWANReceived = 1 << 1,
    BTNetworkTrafficTypeWIFISent     = 1 << 2,
    BTNetworkTrafficTypeWIFIReceived = 1 << 3,
    BTNetworkTrafficTypeAWDLSent     = 1 << 4,
    BTNetworkTrafficTypeAWDLReceived = 1 << 5,
    
    BTNetworkTrafficTypeWWAN = BTNetworkTrafficTypeWWANSent | BTNetworkTrafficTypeWWANReceived,
    BTNetworkTrafficTypeWIFI = BTNetworkTrafficTypeWIFISent | BTNetworkTrafficTypeWIFIReceived,
    BTNetworkTrafficTypeAWDL = BTNetworkTrafficTypeAWDLSent | BTNetworkTrafficTypeAWDLReceived,
    
    BTNetworkTrafficTypeALL = BTNetworkTrafficTypeWWAN |
    BTNetworkTrafficTypeWIFI |
    BTNetworkTrafficTypeAWDL,
};
...
/**
 ...
 Usage:
     ...
     uint64_t bytes = [[UIDevice currentDevice] getNetworkTrafficBytes:BTNetworkTrafficTypeALL];
