...
CGContextRef _Nullable SQCGContextCreateARGBBitmapContext(CGSize size, BOOL opaque, CGFloat scale);

/// Create a `DeviceGray` Bitmap context. Returns NULL if an error occurs.
CGContextRef _Nullable SQCGContextCreateGrayBitmapContext(CGSize size, CGFloat scale);



/// Get main screen's scale.
CGFloat SQScreenScale(void);

/// Get main screen's size. Height is always larger than width.
CGSize SQScreenSize(void);
...
UIViewContentMode SQCAGravityToUIViewContentMode(NSString *gravity);

/// Convert UIViewContentMode to CALayer's gravity string.
NSString *SQUIViewContentModeToCAGravity(UIViewContentMode contentMode);
 ...
 */
CGRect SQCGRectFitWithContentMode(CGRect rect, CGSize size, UIViewContentMode mode);
...
// main screen's scale
#ifndef kScreenScale
#define kScreenScale SQScreenScale()
#endif

// main screen's size (portrait)
#ifndef kScreenSize
#define kScreenSize SQScreenSize()
#endif

// main screen's width (portrait)
#ifndef kScreenWidth
#define kScreenWidth SQScreenSize().width
#endif

// main screen's height (portrait)
#ifndef kScreenHeight
#define kScreenHeight SQScreenSize().height
#endif
