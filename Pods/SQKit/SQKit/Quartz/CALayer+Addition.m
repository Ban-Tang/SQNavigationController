...
- (UIViewContentMode)contentMode {
    return SQCAGravityToUIViewContentMode(self.contentsGravity);
}

- (void)setContentMode:(UIViewContentMode)contentMode {
    self.contentsGravity = SQUIViewContentModeToCAGravity(contentMode);
}
...
- (void)addFadeAnimationWithDuration:(NSTimeInterval)duration curve:(UIViewAnimationCurve)curve {
    ...
    [self addAnimation:transition forKey:@"SQKit.fade"];
}

- (void)removePreviousFadeAnimation {
    [self removeAnimationForKey:@"SQKit.fade"];
}
