...
#pragma mark - Attribute Image String
///=============================================================================
/// @name Attribute Image String
///=============================================================================

/**
 Returns an attributed string by inset an image icon.
 
 @param imageName     The name of an image used for inset to the string.
 
 @return              A new attributed string from self. And the attributed string will contain
                      an image attachment.
 */
- (NSAttributedString *)stringByAppendImageNamed:(NSString *)imageName;

/**
 Returns an attributed string by inset an image icon.
 
 @param image     The image used for inset to the string.
 
 @param index     The index where the image icon will be inseted.
 
 @return          A new attributed string from self. And the attributed string will contain
                  an image attachment.
 */
- (NSAttributedString *)stringByInsertImage:(UIImage *)image atIndex:(NSInteger)index;
